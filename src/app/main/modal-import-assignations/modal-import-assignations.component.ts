...
@Component({
  selector: 'app-modal-import-assignations',
  templateUrl: './modal-import-assignations.component.html',
  styleUrl: './modal-import-assignations.component.css'
})

export class ModalImportAssignationsComponent implements OnInit {
